...
class PixInternalTransactionReport extends Resource {
     ...
     * @param senderAccountType [string]: sender's bank account type. Options: 'checking', 'savings', 'salary', 'payment' or 'other'
     ...
     * @param receiverAccountType [string]: receiver's bank account type. Options: 'checking', 'savings', 'salary', 'payment' or 'other'
