...
class CreditNote extends Resource {
    ...
    constructor({
                    ...
                    externalId, streetLine1, streetLine2, district, city, stateCode, zipCode, rebateAmount=null, tags=null,
                    expiration=null, id=null, amount=null, documentId=null, status=null, transactionIds=null, workspaceId=null, 
                    taxAmount=null, nominalInterest=null, interest=null, created=null, updated=null
                }) {
        super(id);
...
exports.parse = async function ({content, signature, user} = {}) {
    /**
     *
     * Create a single verified CreditNote object from a content string
     *
