...
class IssuingCard extends Resource {
     ...
     * @param rules [list of IssuingRule, default null]: [EXPANDABLE] list of card spending rules.
     ...
     * @param streetLine1 [string, default null]: cardholder main address. ex: "Av. Paulista, 200"
     * @param streetLine2 [string, default null]: cardholder address complement. ex: "Apto. 123"
     * @param district [string]: cardholder address district / neighbourhood. ex: "Bela Vista"
     * @param city [string, default null]: cardholder address city. ex: "Rio de Janeiro"
     * @param stateCode [string, default null]: cardholder address state. ex: "GO"
     * @param zipCode [string, null]: cardholder address zip code. ex: "01311-200"
     * 
